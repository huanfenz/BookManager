...
public class UpdateController {
     ...
     * @return
     */
    private String myUpload(HttpServletRequest req, String dirName) {
        String res = null;  // 返回网络路径
        try {
            String staticDir = ResourceUtils.getURL("classpath:static").getPath();  // 得到classes/static目录
    ...
    public Map<String,Object> updateImg(HttpServletRequest req){
        String resPath = myUpload(req, "pictures");
